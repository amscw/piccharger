...
#define  DATA_LOW   TRISCbits.TRISC1 = 0; // define macro for data pin output
#define  DATA_HI    TRISCbits.TRISC1 = 1; // define macro for data pin input
#define  DATA_LAT   LATCbits.LATC1        // define macro for data pin latch
#define  DATA_PIN   PORTCbits.RC1         // define macro for data pin
